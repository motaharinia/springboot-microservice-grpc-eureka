...
public class SearchFilterModel implements Serializable {
     ...
     */
    private List<com.motaharinia.msjpautility.search.filter.SearchFilterRestrictionModel> restrictionList = new ArrayList<>();
    /**
     * لیستی از ترتیبهای صعودی/نزولی دلخواه
     */
    private List<com.motaharinia.msjpautility.search.filter.SearchFilterSortModel> sortList = new ArrayList<>();
    /**
...
//    private List<Object> parameterValueList = new ArrayList<>();
     ...
     */
    public com.motaharinia.msjpautility.jparepository.GenericSpecification makeSpecification(GenericSpecification genericSpecification) {
    ...
    public Pageable makePageable() {
        Sort allSort = null;
        for (com.motaharinia.msjpautility.search.filter.SearchFilterSortModel searchFilterSortModel : this.getSortList()) {
            Sort newSort = null;
    ...
    //getter-setter:
    public List<com.motaharinia.msjpautility.search.filter.SearchFilterRestrictionModel> getRestrictionList() {
    ...
    public List<com.motaharinia.msjpautility.search.filter.SearchFilterSortModel> getSortList() {
        return sortList;
    }

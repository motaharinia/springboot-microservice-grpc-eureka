...
public class SearchDataColModel implements Serializable {
     ...
     */
    private com.motaharinia.msjpautility.search.data.SearchDataColSortTypeEnum sortType;
    /**
    ...
    private List<com.motaharinia.msjpautility.search.filter.SearchFilterOperationEnum> searchFilterOperationList;
    /**
     ...
     */
    public SearchDataColModel(String name, String index, SearchDataColAlignEnum align, Integer width, com.motaharinia.msjpautility.search.data.SearchDataColSortTypeEnum sortType, SearchDataColSearchTypeEnum searchType, List<com.motaharinia.msjpautility.search.filter.SearchFilterOperationEnum> searchFilterOperationList, String formatter, Boolean searchable, Boolean sortable) {
        this.name = name;
        this.index = index;
        this.align = align;
        this.width = width;
    ...
    public com.motaharinia.msjpautility.search.data.SearchDataColSortTypeEnum getSortType() {
        return sortType;
    }
    ...
    public List<com.motaharinia.msjpautility.search.filter.SearchFilterOperationEnum> getSearchFilterOperationList() {

...
//        String[] openAuthenticationUriArray = OpenUriConfig.getOpenUriAuthenticationArray();
        String[] openAuthenticationUriArray = new String[]{"/","/gui","/graphql","/error**","/actuator/**","/fso/**","/v1/async/**", "/v1/captchaCode/**","/v1/adminUser**","/v1/adminUser/**","/v1/etcItem**","/v1/getCombo**","/v1/adminUserOrganizationUnit/**","/v1/buildIndexRun/**","/v1/async/**"};
        http.cors().and()
                .authorizeRequests()

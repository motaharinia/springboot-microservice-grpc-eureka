 ...
 */
@Repository
public interface StateRepository extends JpaRepository<State, Integer>, JpaSpecificationExecutorWithProjection<State> {

    State findByReferenceCodeEquals(String referenceCode);

package ir.micser.login.presentation.adminuserorganizationunit;

import com.motaharinia.msutility.customexception.BusinessException;
import com.motaharinia.msutility.customexception.UtilityException;
import com.motaharinia.msutility.jstree.JstreeNodeModel;
import ir.micser.login.business.service.adminuserorganizationunit.AdminUserOrganizationUnitService;
...
public class AdminUserOrganizationUnitController {
     ...
     */
    @PostMapping("/v1/adminUserOrganizationUnit")
     ...
     * @return خروجی: درخت
     */
    @GetMapping("/v1/adminUserOrganizationUnit/{id}")

...
public class LogUploadedFileController {
    ...
    public @ResponseBody
    FineUploaderResponseModel uploadFrontPanel(HttpServletRequest request, Locale locale,
                                               @RequestParam(required = true) String qquuid,
                                               @RequestParam(required = true) String qqfilename,
                                               @RequestParam(required = true) Long qqtotalfilesize,
                                               @RequestParam(required = true)  MultipartFile qqfile,
                                               @RequestParam(required = false, defaultValue = "0") Integer qqpartindex,

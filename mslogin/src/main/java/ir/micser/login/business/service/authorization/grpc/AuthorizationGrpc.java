...
public final class AuthorizationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessRequestModel,
      ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessResponseModel> getCheckAccessMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "checkAccess",
      requestType = ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessRequestModel.class,
      responseType = ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessResponseModel.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessRequestModel,
      ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessResponseModel> getCheckAccessMethod() {
    io.grpc.MethodDescriptor<ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessRequestModel, ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessResponseModel> getCheckAccessMethod;
      ...
      synchronized (AuthorizationGrpc.class) {
        if ((getCheckAccessMethod = AuthorizationGrpc.getCheckAccessMethod) == null) {
          AuthorizationGrpc.getCheckAccessMethod = getCheckAccessMethod = 
              io.grpc.MethodDescriptor.<ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessRequestModel, ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessResponseModel>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Authorization", "checkAccess"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessRequestModel.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessResponseModel.getDefaultInstance()))
  ...
  public static abstract class AuthorizationImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void checkAccess(ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessRequestModel request,
        io.grpc.stub.StreamObserver<ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessResponseModel> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessRequestModel,
                ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessResponseModel>(
  ...
  public static final class AuthorizationBlockingStub extends io.grpc.stub.AbstractStub<AuthorizationBlockingStub> {
    ...
    /**
     */
    public ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessResponseModel checkAccess(ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessRequestModel request) {
  ...
  public static final class AuthorizationFutureStub extends io.grpc.stub.AbstractStub<AuthorizationFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessResponseModel> checkAccess(
        ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessRequestModel request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK_ACCESS:
          serviceImpl.checkAccess((ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessRequestModel) request,
              (io.grpc.stub.StreamObserver<ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.CheckAccessResponseModel>) responseObserver);
          break;
        default:
  ...
  private static abstract class AuthorizationBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ir.micser.login.business.service.authorization.grpc.AuthorizationOuterClass.getDescriptor();
    }

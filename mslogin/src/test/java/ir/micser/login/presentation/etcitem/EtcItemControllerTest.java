...
import ir.micser.login.presentation.generic.EntityEnum;
import ir.micser.login.presentation.generic.EntityParametersModeEnum;
...
public class EtcItemControllerTest {
    ...
    public void comboTest() throws Exception {
        try {
            String uri = "http://localhost:" + port + "/v1/getCombo";

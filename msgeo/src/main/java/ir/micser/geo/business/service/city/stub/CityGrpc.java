...
@javax.annotation.Generated(
    ...
    comments = "Source: CityMicro.proto")
public final class CityGrpc {
   ...
   */
  public static CityStub newStub(io.grpc.Channel channel) {
    return new CityStub(channel);
  }

  /**
   * Creates a new blocking-style stub that supports unary and streaming output calls on the service
   */
  public static CityBlockingStub newBlockingStub(
      io.grpc.Channel channel) {
    return new CityBlockingStub(channel);
  }

  /**
   * Creates a new ListenableFuture-style stub that supports unary calls on the service
   */
  public static CityFutureStub newFutureStub(
      io.grpc.Channel channel) {
    return new CityFutureStub(channel);
  }

  /**
   */
  public static abstract class CityImplBase implements io.grpc.BindableService {
  ...
  /**
   */
  public static final class CityStub extends io.grpc.stub.AbstractStub<CityStub> {
    private CityStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @java.lang.Override
    protected CityStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
      return new CityStub(channel, callOptions);
    }
  ...
  /**
   */
  public static final class CityBlockingStub extends io.grpc.stub.AbstractStub<CityBlockingStub> {
    private CityBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @java.lang.Override
    protected CityBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
      return new CityBlockingStub(channel, callOptions);
    }
  ...
  /**
   */
  public static final class CityFutureStub extends io.grpc.stub.AbstractStub<CityFutureStub> {
    private CityFutureStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @java.lang.Override
    protected CityFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
      return new CityFutureStub(channel, callOptions);
    }
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    private final CityImplBase serviceImpl;
    private final int methodId;

    MethodHandlers(CityImplBase serviceImpl, int methodId) {
  ...
  private static abstract class CityBaseDescriptorSupplier
      implements io.grpc.protobuf.ProtoFileDescriptorSupplier, io.grpc.protobuf.ProtoServiceDescriptorSupplier {
    CityBaseDescriptorSupplier() {}

    @java.lang.Override
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ir.micser.geo.business.service.city.stub.CityMicro.getDescriptor();
    }

    @java.lang.Override
    public com.google.protobuf.Descriptors.ServiceDescriptor getServiceDescriptor() {
      return getFileDescriptor().findServiceByName("City");
    }
  }

  private static final class CityFileDescriptorSupplier
      extends CityBaseDescriptorSupplier {
    CityFileDescriptorSupplier() {}
  }

  private static final class CityMethodDescriptorSupplier
      extends CityBaseDescriptorSupplier
      implements io.grpc.protobuf.ProtoMethodDescriptorSupplier {
    private final String methodName;

    CityMethodDescriptorSupplier(String methodName) {
